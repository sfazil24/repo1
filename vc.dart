...
class zbm extends StatelessWidget {
  const zbm({super.key});
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text("Suna Hai - Jubin Nautiyal", style: TextStyle(
                  ...
                  Center(
                    child: Column(
                      children: [
                        Icon(Icons.camera_alt_outlined, color: Colors.white24,
                            size: 50),
                        SizedBox(height: 10),
                        Text("No posts yet", style: TextStyle(color: Colors
                            .white30)),
                      ],
                    ),
                  ),
